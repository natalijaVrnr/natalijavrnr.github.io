...
public class Program
{
    ...
    //public static void WriteParticipatingCountriesToFile(HtmlDocument doc, int year)
    //{
    ...
    //    {
    //        string filePath = @$"C:\Users\vernenat\OneDrive - Tietoevry\EurovisionFanPageFiles\DatabaseFiles\allParticipants\allParticipants_{year}";
    //        var firstLine = "Country,Artist,Song";
    ...
    //                    var country = cells[0].InnerText.Trim().Substring(6);
    //                    var artist = cells[1].InnerText.Trim();
    //                    var song = cells[2].InnerText.Trim();

    //                    sw.WriteLine($"{country}|{artist}|{song}");
